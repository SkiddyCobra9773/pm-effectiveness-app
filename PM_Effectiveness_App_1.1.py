...
# STREAMLIT UI
# ═════════════════════════════════════════════════════════════════════════════
st.set_page_config(page_title="PM Effectiveness App 1.1", page_icon="🔧", layout="centered")

st.title("PM Effectiveness App 1.1")
st.caption("Upload a Celonis export. Get a 7-pillar analysis workbook with dynamic priority actions.")
